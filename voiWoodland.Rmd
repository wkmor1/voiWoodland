...
\begin{equation}
\begin{aligned}
&\textrm{max}_{NM,HF,ET}(MHDW_{t = 150} + MLDW_{t = 150})\\
&\textrm{subject to}\\
&ET < 0.2\\
&NM + HF + ET < 1 
\end{aligned}
...
(ref:paramplot) Frequency histogram of a STM parameter. Histogram shows expert elicited estimates of the probability of a section of the BIFAW transitioning from HDRG to LDRG due to windthrow if the ecological management option is used.
