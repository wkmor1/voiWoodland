...
```{r management_plot, fig.cap = management_plot_caption, echo = FALSE, warning = FALSE}
ggtern(
  data = 
    data_frame(
...
```{r results_plot1, fig.cap = results_plot1_caption, echo = FALSE}
ggplot(evi) +
...
```{r results_plot2, fig.cap = results_plot2_caption, echo = FALSE}
ggplot() +
aes(x = max_eco, y = evi) +
geom_line(
  data = evpi_df,
