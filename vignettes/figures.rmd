...
```{r management_plot, fig.cap = management_plot_caption, dpi = 300}
ggtern(
  data =
    data_frame(
...
```{r param_plot, fig.cap = param_plot_caption, dpi = 300}
...
```{r results_plot1, fig.cap = results_plot1_caption, dpi = 300}
ggplot(evi) +
...
```{r results_plot2, fig.cap = results_plot2_caption, dpi = 300}
ggplot() +
aes(x = max_eco, y = evi) +
geom_line(
  data = evpi_df,
