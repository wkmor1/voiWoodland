...
As noted above, value of information can take multiple forms. Here we deal with two forms: the expected value of perfect information (EVPI) and the partial expected value of perfect information (EVPXI).<!--- here i need a sentance to explain what X is --->. Here we will briefly outline the general form of an EVI analysis in terms of EVPI and EVPXI. For a more detailed description of the derivation of EVI and its variants, see the seminal text of @Raiffa1968 and for more recent treatments see @Yokota2004 and @Williams2011.
