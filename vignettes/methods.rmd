...
<!---
Here I need to explain again that ther actions are only applied once.
--->
...
<!---
Explain that if the STM had the additional dynamically complexiting then we would not be able to make this assumptinon about the optima lying at the vertices of the feasible region and it would be possible to find optimal solutions in the inner region.
--->
