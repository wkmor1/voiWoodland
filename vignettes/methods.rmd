...
All analyses were done using the statistical computing language R version 3.2.3 [@R2015] with the MARS models fit (see R code provided in supplement for the specific model parameters used) using the software package 'earth' version 4.4.4 [@Milborrow2013].
